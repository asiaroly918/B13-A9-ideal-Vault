      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-base-content/60 text-sm leading-relaxed mb-5">
              A community-driven platform where innovators share, discover, and validate startup ideas together.
            </p>
          ...
          {/* Platform Links */}
          <div>
            <h3 className="font-bold text-base mb-4 text-base-content">Platform</h3>
            <ul className="space-y-2.5">
              {[
                ...
                { to: "/ideas?sort=trending", label: "Trending Ideas" },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    to={link.to}
          ...
          {/* Categories */}
          <div>
            <h3 className="font-bold text-base mb-4 text-base-content">Categories</h3>
            <ul className="space-y-2.5">
              {["Tech", "Health", "AI", "Education", "Finance", "Environment", "Social", "Entertainment"].map((cat) => (
                <li key={cat}>
                  <Link
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold text-base mb-4 text-base-content">Contact Us</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <FiMail className="text-violet-500 mt-0.5 shrink-0" />
                <div>
                  <p className="text-sm text-base-content/60">Email</p>
                  <a href="mailto:hello@ideavault.io" className="text-sm font-medium hover:text-violet-600 transition-colors">
                    hello@ideavault.io
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+15551234567" className="text-sm font-medium hover:text-violet-600 transition-colors">
                    +1 (555) 123-4567
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">San Francisco, CA 94105</p>
                </div>
              </li>
            </ul>

            <div className="mt-5 p-4 bg-gradient-to-r from-violet-600/10 to-purple-600/10 rounded-xl border border-violet-200/50">
              <p className="text-xs font-semibold text-violet-700 dark:text-violet-400 mb-1">Newsletter</p>
              <p className="text-xs text-base-content/60 mb-3">Get weekly idea highlights</p>
        ...
        <div className="mt-10 pt-6 border-t border-base-300 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs text-base-content/40">
            ...
            <span>·</span>
            <Link to="/cookies" className="hover:text-violet-600 transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
