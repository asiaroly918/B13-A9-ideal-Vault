          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl overflow-hidden h-64 sm:h-80 relative">
              <img
                ...
                onError={(e) => {
                  (e.target).src = `https://placehold.co/800x400/7c3aed/ffffff?text=${encodeURIComponent(idea.title.slice(0, 2))}`;
                }}
              />
                  ...
                  <div className="avatar">
                    <div className="w-8 h-8 rounded-full ring-2 ring-violet-300">
                      <img src={idea.authorPhoto} alt={idea.authorName}
                        onError={(e) => { e.target.src = `https://api.dicebear.com/7.x/initials/svg?seed=${idea.authorName}`; }}
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  .map((relIdea) => (
                    ...
                    >
                      <img
                        ...
                        onError={(e) => { (e.target).src = `https://placehold.co/100x100/7c3aed/ffffff?text=${relIdea.category}`; }}
                      />
